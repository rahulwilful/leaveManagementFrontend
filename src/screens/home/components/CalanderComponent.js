...
import {fullWhite, primaryColor} from '../../../Constants/Colours';
import {
  leftArrowCircleIcon,
  nextArrowIcon,
  previousArrowIcon,
...
const CalanderCompnent = () => {
  ...
  const customTheme = {
    backgroundColor: 'rgb(255,255,255)', // Change this to your desired background color
    calendarBackground: 'rgb(255,255,255)', // Change this to your desired background color
